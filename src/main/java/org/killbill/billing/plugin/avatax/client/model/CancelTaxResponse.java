...
public class CancelTaxResponse {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("CancelTaxResponse{");
        sb.append("CancelTaxResult=").append(CancelTaxResult);
    ...
    public boolean equals(final Object o) {
        ...
        final CancelTaxResponse that = (CancelTaxResponse) o;

        if (CancelTaxResult != null ? !CancelTaxResult.equals(that.CancelTaxResult) : that.CancelTaxResult != null) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        int result = CancelTaxResult != null ? CancelTaxResult.hashCode() : 0;
